...
var nn = new Denn(X, Y, formation, learning_rate, Activation.relu, Activation.softPlus, 'ONEHOT', onehot_to_labels);

// Train DNN
let epochs = 1000, batch_size = 10, error_threshold = 0.01, backtrack = true, verbose = true;
...
// Resume training
//nn2.train(epochs, batch_size, error_threshold, false, verbose);
