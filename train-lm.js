...
let learning_rate = 1, epochs = 10000, batch_size = 20, error_threshold = 0.02, verbose = true;
...
let nn = new Denn(X, Y, formation, learning_rate, Activation.sigmoid, 'ONEHOT', binary_to_label_map);
// Train DNN
