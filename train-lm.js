...
let learning_rate = 0.5, epochs = 100, batch_size = 10, error_threshold = 0.02, verbose = true;
...
let nn = new Denn(X, Y, formation, learning_rate, Activation.sigmoid, Activation.sigmoid, 'ONEHOT', binary_to_label_map);
// Train DNN
